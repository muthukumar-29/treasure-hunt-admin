...
const ListQuery = React.lazy(() => import('./pages/ListQuery'))
const GenerateQR = React.lazy(() => import('./pages/GenerateQR'))
...
const routes = [
  ...
  { path: '/queries/view-queries', name: 'Questions', element: ListQuery },
